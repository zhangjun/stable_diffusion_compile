...
from diffusers.utils import USE_PEFT_BACKEND, logging, scale_lora_layers, unscale_lora_layers, deprecate, is_torch_version, BaseOutput
...
# class UNet2DConditionModel(ConfigMixin, nn.Module):
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if addition_embed_type == "text_image":
    ...
    def forward(
        ...
        #         print("forward_upsample_size: ", forward_upsample_size)
        #         break
